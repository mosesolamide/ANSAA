...
export default function RegLogLayout() {
    return(
        <div className="bg-[url('/images/Form.png')] h-screen w-[100vw] bg-cover flex flex-wrap justify-center items-center px-4 gap-6">
            ...
            <form className='bg-white w-[350px] h-96 sm:h-[70%] rounded-sm flex flex-col items-center p-4'>
