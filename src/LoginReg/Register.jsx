...
export default function Register(){
    return(
        <>
            <p className="text-buttonColor text-sm mr-auto mb-2 font-bold">Select Registration Type</p>
            ...
            <div className="w-[100%] border-2 mt-3 h-[130px] text-buttonColor flex flex-col gap-2 p-3">
