        ...
        <header>
             <nav className='p-4 flex justify-around w-[100vw] items-center'>
                ...
                <div className="relative">
                    ...
                    <ul className={`md:flex md:gap-5 text-[10px] lg:text-sm md:items-center absolute
                         md:static ${hideSideBar ? 'hidden' : ''} md:block ${!hideSideBar ? 'bg-white' : ''} 
                         md:bg-transparent rounded-md w-[115px] md:w-full`
                        }>
